...
func (c *testServiceClient) GetChattyServer(ctx context.Context, in *ChattyRequest, opts ...grpc.CallOption) (TestService_GetChattyServerClient, error) {
	stream, err := c.cc.NewStream(ctx, &TestService_ServiceDesc.Streams[0], TestService_GetChattyServer_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *testServiceClient) GetChattyClient(ctx context.Context, opts ...grpc.CallOption) (TestService_GetChattyClientClient, error) {
	stream, err := c.cc.NewStream(ctx, &TestService_ServiceDesc.Streams[1], TestService_GetChattyClient_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *testServiceClient) GetChattyBidi(ctx context.Context, opts ...grpc.CallOption) (TestService_GetChattyBidiClient, error) {
	stream, err := c.cc.NewStream(ctx, &TestService_ServiceDesc.Streams[2], TestService_GetChattyBidi_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
