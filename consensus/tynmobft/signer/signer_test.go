...
var (
	...
	blsValidator1 = validators.NewBLSValidator(testAddr1, testBLSPubKey1, big.NewInt(0))
	blsValidator2 = validators.NewBLSValidator(testAddr2, testBLSPubKey2, big.NewInt(0))
