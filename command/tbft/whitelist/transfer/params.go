...
type whitelistParams struct {
	...
	// accounts to add into whitelist
...
func (p *whitelistParams) getResult(hashRet string) command.CommandResult {
	return &transferWhitelistResult{
		PublicAddress:  p.validatorAddress,
